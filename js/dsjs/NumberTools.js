...
(function (dsector) {
    class NumberTools {
        static largeInteger_$LI$() { if (NumberTools.largeInteger == null) {
            NumberTools.largeInteger = 2147483647;
        } return NumberTools.largeInteger; }
        static largeLong_$LI$() { if (NumberTools.largeLong == null) {
            NumberTools.largeLong = 9223372036854775807;
        } return NumberTools.largeLong; }
        static smallPositiveFloat_$LI$() { if (NumberTools.smallPositiveFloat == null) {
