 ...
 * @license  AGPLv3
 */
export class RobotSpecification {
    /**
    ...
    static TRUE = 1;
    static FALSE = 0;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_RANDOM_WEAPON_STRATEGY = 10;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_1 = 11;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_2 = 12;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_3 = 13;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_4 = 14;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_5 = 15;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_6 = 16;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_7 = 17;
    static MOST_FAVORED_WEAPON_AFFORDABLE_FROM_WEAPON_STRATEGY_8 = 18;
    static MOST_EXPENSIVE_TANK_WITHOUT_DOWNGRADING = 21;
    static FUEL_UPGRADE = 22;
    static METAL_UPGRADE = 23;
    static TURN_UPGRADE = 24;
    static SPEED_UPGRADE = 25;
    static SHOPPING_CARD = 26;
    static AS_MANY_SCORE_BRIBES_AS_AFFORDABLE = 27;
    static SHOPPING_CONDITION_ALWAYS = 40;
    static SHOPPING_CONDITION_MORE_THAN_500_CREDITS = 41;
    static SHOPPING_CONDITION_MORE_THAN_1000_CREDITS = 42;
    static SHOPPING_CONDITION_MORE_THAN_2000_CREDITS = 43;
    static SHOPPING_CONDITION_MORE_THAN_3000_CREDITS = 44;
    static SHOPPING_CONDITION_MORE_THAN_4000_CREDITS = 45;
    static SHOPPING_CONDITION_MORE_THAN_6000_CREDITS = 46;
    static SHOPPING_CONDITION_MORE_THAN_8000_CREDITS = 47;
    static SHOPPING_CONDITION_MORE_THAN_10000_CREDITS = 48;
    static SHOPPING_CONDITION_MORE_THAN_15000_CREDITS = 49;
    static SHOPPING_CONDITION_MORE_THAN_20000_CREDITS = 50;
    static SHOPPING_CONDITION_5_PERCENT = 51;
    static SHOPPING_CONDITION_10_PERCENT = 52;
    static SHOPPING_CONDITION_25_PERCENT = 53;
    static SHOPPING_CONDITION_50_PERCENT = 54;
    static SHOPPING_CONDITION_75_PERCENT = 55;
    static SHOPPING_CONDITION_MORE_THAN_25_ROUNDS_REMAINING = 56;
    static SHOPPING_CONDITION_MORE_THAN_50_ROUNDS_REMAINING = 57;
    static SHOPPING_CONDITION_MORE_THAN_100_ROUNDS_REMAINING = 58;
    static SHOPPING_CONDITION_MORE_THAN_150_ROUNDS_REMAINING = 59;
    static SHOPPING_CONDITION_3_ROUNDS_REMAINING = 60;
    static SHOPPING_CONDITION_6_ROUNDS_REMAINING = 61;
    static SHOPPING_CONDITION_9_ROUNDS_REMAINING = 62;
    static SHOPPING_CONDITION_12_ROUNDS_REMAINING = 63;
    static SHOPPING_CONDITION_15_ROUNDS_REMAINING = 64;
    static SHOPPING_CONDITION_18_ROUNDS_REMAINING = 65;
    static SHOPPING_CONDITION_PORT_1_EMPTY = 66;
    static SHOPPING_CONDITION_PORT_2_EMPTY = 67;
    static SHOPPING_CONDITION_PORT_3_EMPTY = 68;
    static SHOPPING_CONDITION_PORT_4_EMPTY = 69;
    static SHOPPING_CONDITION_PORT_5_EMPTY = 70;
    static SHOPPING_CONDITION_PORT_6_EMPTY = 71;
    static SHOPPING_CONDITION_PORT_1_BELOW_100_FIRE_UNITS = 72;
    static SHOPPING_CONDITION_PORT_2_BELOW_100_FIRE_UNITS = 73;
    static SHOPPING_CONDITION_PORT_3_BELOW_100_FIRE_UNITS = 74;
    static SHOPPING_CONDITION_PORT_4_BELOW_100_FIRE_UNITS = 75;
    static SHOPPING_CONDITION_PORT_5_BELOW_100_FIRE_UNITS = 76;
    static SHOPPING_CONDITION_PORT_6_BELOW_100_FIRE_UNITS = 77;
    static NO_ACTION = 100;
    static TURN_LEFT = 101;
    static TURN_LEFT_10_DEGREES = 102;
    static TURN_LEFT_90_DEGREES = 103;
    static TURN_LEFT_180_DEGREES = 104;
    static TURN_RIGHT = 105;
    static TURN_RIGHT_10_DEGREES = 106;
    static TURN_RIGHT_90_DEGREES = 107;
    static TURN_RIGHT_180_DEGREES = 108;
    static SET_TARGET_AS_TANK_LAST_DETECTED_WITH_SENSOR = 109;
    static SET_TARGET_AS_NEAREST_TANK = 110;
    static SET_TARGET_AS_NEAREST_ENEMY_TANK_OR_JEWEL = 111;
    static SET_TARGET_AS_ENEMY_JEWEL = 112;
    static SET_TARGET_AS_ENEMY_TANK_WITH_HIGHEST_SCORE = 113;
    static SET_TARGET_AS_ENEMY_TANK_WITH_LOWEST_SCORE = 114;
    static SET_TARGET_AS_TANK_LAST_TAKEN_HIT_FROM = 115;
    static ROTATE_TO_CORRECT_DIRECTION_ALONG_SHORTEST_PATH_TO_TARGET = 116;
    static TURN_TOWARDS_TARGET = 117;
    static MOVE_FORWARDS = 118;
    static MOVE_BACKWARDS = 119;
    static SUPRESS_MOVEMENT_INSTRUCTIONS_FOR_1_SECOND = 120;
    static SUPRESS_MOVEMENT_INSTRUCTIONS_FOR_2_SECONDS = 121;
    static SUPRESS_MOVEMENT_INSTRUCTIONS_FOR_4_SECONDS = 122;
    static SUPRESS_ROTATION_INSTRUCTIONS_FOR_1_SECOND = 123;
    static SUPRESS_ROTATION_INSTRUCTIONS_FOR_2_SECONDS = 124;
    static SUPRESS_ROTATION_INSTRUCTIONS_FOR_4_SECONDS = 125;
    static STOP_MOVING = 126;
    static STOP_ROTATING = 127;
    static MOVE_RANDOM_DIRECTION = 128;
    static TURN_RANDOM_DIRECTION = 129;
    static FIRE_STRATEGY_1 = 130;
    static FIRE_STRATEGY_2 = 131;
    static FIRE_STRATEGY_3 = 132;
    static FIRE_STRATEGY_4 = 133;
    static FIRE_STRATEGY_5 = 134;
    static FIRE_STRATEGY_6 = 135;
    static FIRE_STRATEGY_7 = 136;
    static FIRE_STRATEGY_8 = 137;
    static ROTATE_TURRET_TO_TARGET = 138;
    static POINT_TURRET_DIRECTLY_AT_TARGET = 139;
    static TURN_ON_SHIELD = 140;
    static ANY_CONDITION = 167;
    static DESTINATION_TANK_WITHIN_2_TANK_LENGTHS = 168;
    static DESTINATION_TANK_OR_JEWEL_WITHIN_2_TANK_LENGTHS = 169;
    static DESTINATION_TANK_OR_JEWEL_WITHIN_5_TANK_LENGTHS = 170;
    static DESTINATION_TANK_OR_JEWEL_WITHIN_10_TANK_LENGTHS = 171;
    static ENEMY_MISSILE_WITHIN_1_TANK_LENGTH = 172;
    static ENEMY_MISSILE_WITHIN_2_TANK_LENGTHS = 173;
    static ENEMY_MISSILE_WITHIN_3_TANK_LENGTHS = 174;
    static ENEMY_MISSILE_WITHIN_4_TANK_LENGTHS = 175;
    static PROBABILITY_OF_1_PERCENT = 176;
    static PROBABILITY_OF_2_PERCENT = 177;
    static PROBABILITY_OF_5_PERCENT = 178;
    static PROBABILITY_OF_10_PERCENT = 179;
    static PROBABILITY_OF_25_PERCENT = 180;
    static PROBABILITY_OF_50_PERCENT = 181;
    static SENSOR_1_DETECTING_TANK_OR_JEWEL = 182;
    static SENSOR_2_DETECTING_TANK_OR_JEWEL = 183;
    static SENSOR_3_DETECTING_TANK_OR_JEWEL = 184;
    static SENSOR_4_DETECTING_TANK_OR_JEWEL = 185;
    static SENSOR_5_DETECTING_TANK_OR_JEWEL = 186;
    static SENSOR_6_DETECTING_TANK_OR_JEWEL = 187;
    static SENSOR_7_DETECTING_TANK_OR_JEWEL = 188;
    static SENSOR_8_DETECTING_TANK_OR_JEWEL = 189;
    static SENSOR_9_DETECTING_TANK_OR_JEWEL = 190;
    static SENSOR_10_DETECTING_TANK_OR_JEWEL = 191;
    static SENSOR_11_DETECTING_TANK_OR_JEWEL = 192;
    static SENSOR_12_DETECTING_TANK_OR_JEWEL = 193;
    static SENSOR_13_DETECTING_TANK_OR_JEWEL = 194;
    static SENSOR_14_DETECTING_TANK_OR_JEWEL = 195;
    static SENSOR_15_DETECTING_TANK_OR_JEWEL = 196;
    static SENSOR_16_DETECTING_TANK_OR_JEWEL = 197;
    static ENEMY_TANK_OR_JEWEL_IN_LINE_OF_SIGHT_FROM_TURRET = 198;
    static NO_ENEMY_TANK_OR_JEWEL_NEAR = 199;
    static WITHIN_OPTIMAL_ZONE_FOR_FIRING_AT_JEWEL = 200;
    static NOT_WITHIN_OPTIMAL_ZONE_FOR_FIRING_AT_JEWEL = 201;
    static SENSOR_1_DETECTING_WALL = 202;
    static SENSOR_2_DETECTING_WALL = 203;
    static SENSOR_3_DETECTING_WALL = 204;
    static SENSOR_4_DETECTING_WALL = 205;
    static SENSOR_5_DETECTING_WALL = 206;
    static SENSOR_6_DETECTING_WALL = 207;
    static SENSOR_7_DETECTING_WALL = 208;
    static SENSOR_8_DETECTING_WALL = 209;
    static SENSOR_9_DETECTING_WALL = 210;
    static SENSOR_10_DETECTING_WALL = 211;
    static SENSOR_11_DETECTING_WALL = 212;
    static SENSOR_12_DETECTING_WALL = 213;
    static SENSOR_13_DETECTING_WALL = 214;
    static SENSOR_14_DETECTING_WALL = 215;
    static SENSOR_15_DETECTING_WALL = 216;
    static SENSOR_16_DETECTING_WALL = 217;
    static NO_PLAYER_MOVED_FORWARD_FOR_2_SECONDS = 218;
    static ALL_ENEMIES_DESTROYED = 219;
    static AT_LEAST_ONE_ENEMY_ALIVE = 220;
    static variablestringRepresentations = null;
}