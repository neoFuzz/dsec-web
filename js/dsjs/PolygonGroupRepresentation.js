...
(function (dsector) {
    class PolygonGroupRepresentation {
        constructor(polygonGroup, name, visible, e00, e10, e20, e30, e01, e11, e21, e31, e02, e12, e22, e32, e03, e13, e23, e33) {
            ...
            this.transformationMatrix = new dsector.Matrix4f(e00, e10, e20, e30, e01, e11, e21, e31, e02, e12, e22, e32, e03, e13, e23, e33);
            this.active = false;
        }
        ...
        setActive() {
            if (!CWSYSTEM.Environment.shiftKeyPressed) {
                const arrayList = PolygonGroupRepresentation.allPolygonGroupRepresentations(dsector.DSReference.model3DMatrix);
            ...
            if (this.isDirectRepresentation()) {
                for (let i = 0; i < /* size */ this.parentPolygonGroup.polygons.length; ++i) {
                    {
        ...
        static allPolygonGroupRepresentations(matrix) {
            const arrayList = ([]);
            const polygonIterator = new dsector.PolygonIterator(matrix, dsector.PolygonIterator.ALL_POLYGON_GROUPS);
            while ((true)) {
                {
                    ...
                    for (let i = -1; i < /* size */ polygonGroup.transposedRepresentations.length; ++i) {
                        {
                            let pgr;
                            if (i === -1) {
