 ...
 * @license  AGPLv3
 */
export class DSecBackgroundConfiguration {
    /**
    ...
    static SMALL_BLOCK = 0;
    static SMALL_SPHERE = 1;
    static SHORT_LINE = 2;
    static MEDIUM_LINE = 3;
    static LONG_LINE = 4;
    static LONG_LINE_45_SHORT_LINE1 = 7;
    static LONG_LINE_45_SHORT_LINE2 = 8;
    static SQUARE_LOOP1 = 9;
    static SQUARE_LOOP2 = 10;
    static SQUARE_LOOP3 = 11;
    static LARGE_SPHERE = 12;
    static numberOfPresetConfigurations = 8;
}