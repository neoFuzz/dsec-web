...
export class CWWindow {
     ...
     */
    static maximumNumberOfButtons = 100;
    static maximumNumberOfImages = 100;
    static maximumNumberOfInputBoxes = 100;
    static maximumNumberOfTextAreas = 100;
    static maximumNumberOfCheckBoxes = 100;
    static maximumNumberOfTextElements = 400;
    static maximumNumberOfImageElements = 100;
