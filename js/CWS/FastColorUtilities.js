 ...
 * @license  AGPLv3
 */
export class FastColorUtilities {
    /**
     ...
     * @type {number}
     */
    static alphaMask = -16777216;
    static gammaCorrectionLookupTable = null;
    static gammaCorrection = 1.2;
