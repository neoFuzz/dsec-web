...
(function (CWSYSTEM) {
    class CWPulldown {
        ...
        draw() {
            ...
            vs.CWDrawFilledRectangle(this.parent.window, intWidth + 1, titleWitdth + 1, this.width - 2, this.height - 2, CWPulldown.boxColor_$LI$());
            ...
            CWSYSTEM.CWFontTools.renderText(this.parent.window, spName, intWidth + 4, titleWitdth + (this.height / 2 | 0) + 6, this.titleBoxFont, CWPulldown.textColor_$LI$(), 999);
            const cwp = [
                [[255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [85, 85, 85]],
                [[255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [153, 153, 153], [85, 85, 85]],
                [[255, 255, 255], [255, 255, 255], [215, 215, 215], [215, 215, 215], [125, 125, 125], [215, 215, 215], [215, 215, 215], [153, 153, 153], [85, 85, 85]],
                [[255, 255, 255], [255, 255, 255], [215, 215, 215], [125, 125, 125], [0, 0, 0], [125, 125, 125], [215, 215, 215], [153, 153, 153], [85, 85, 85]],
                [[255, 255, 255], [255, 255, 255], [125, 125, 125], [0, 0, 0], [0, 0, 0], [0, 0, 0], [125, 125, 125], [153, 153, 153], [85, 85, 85]],
                [[255, 255, 255], [125, 125, 125], [55, 55, 55], [55, 55, 55], [55, 55, 55], [55, 55, 55], [55, 55, 55], [123, 123, 123], [85, 85, 85]],
                [[255, 255, 255], [225, 225, 225], [225, 225, 225], [225, 225, 225], [225, 225, 225], [225, 225, 225], [225, 225, 225], [153, 153, 153], [85, 85, 85]],
                [[255, 255, 255], [173, 173, 173], [173, 173, 173], [173, 173, 173], [173, 173, 173], [173, 173, 173], [173, 173, 173], [133, 133, 133], [85, 85, 85]],
            ...
            for (i = 0; i < 9; ++i) {
                for (let j = 0; j < 9; ++j) {
                    ...
                    vs.CWDrawPixel(this.parent.window, intWidth + j + this.width - 11, titleWitdth + (this.height / 2 | 0) - i + 3);
                }
            }
        }
        ...
        mousePressedOverClosedSectionOrOverlayBorder() {
            ...
            if (this.status === this.CLOSED) {
                ...
                if (cSize > CWSYSTEM.Global.screenResolutionY_$LI$() - 20) {
                    ...
                    for (let k = 0; k < j; ++k) {
                        this.options.splice(/* size */ this.options.length - 1, 1)[0];
                    }
                    cSize = /* size */ this.options.length * (this.popupWindowItemHeight - 1) + 3;
                }
                if (moveY + cSize > CWSYSTEM.Global.screenResolutionY_$LI$() - 10) {
                    moveY = CWSYSTEM.Global.screenResolutionY_$LI$() - cSize - 10;
                }
                this.overlay = dsector.DSReference.gui.addWindow$name$style$title$x$y$w$h$v("overlay", 3, "", this.parent.xPosition + this.x + (this.parent.borderWidth / 2 | 0), moveY, this.width - this.parent.borderWidth, cSize, true);
                ...
                for (i = 0; i < /* size */ this.options.length; ++i) {
                    let name = this.options[i].name;
                    name = CWSYSTEM.CWStringTools.stringReplaceCaseInsensitive(name, "\n", "");
                    const overlayStr = "overlay_" + i;
                    this.overlay.addButton$name$x$y$len$h$text$t$r(overlayStr, 1, 1 + (this.popupWindowItemHeight - 1) * i, this.width - 8, this.popupWindowItemHeight - 1, name, 10, 1);
        ...
        optionSelected(button) {
            ...
            if (this.objectContainingPulldownChangedMethod != null) {
                ...
                try {
                    ...
                    console.error("A problem occured in CWPulldown.optionSelected()for pulldown \'" + this.name + "\': " + e);
                }
            }
        }
    }
