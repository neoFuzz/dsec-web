...
export class Environment {
     ...
     * @type {boolean}
     */
    static screenHasChanged = true;

    /**
     * @static
     * @type {number}
     */
    static furtherRendering = 0;
     ...
     * @type {boolean}
     */
    static altKeyPressed = false;
    /**
     * @static
     * @type {boolean}
     */
    static spacebarPressed = false;
    /**
     * @static
     * @type {boolean}
     */
    static mouseButtonOrAnyKeyPressed = false;
    /**
     * @static
     * @type {boolean}
     */
    static VK_q_Pressed = false;
    /**
     * @static
     * @type {number}
     */
    static timeWhenMouseLastClicked = 0;
    /**
     * @static
     * @type {number}
     */
     ...
     * @type {number}
     */
    static lastFramePeriod = 0;
    /**
     * @static
     * @type {CWInputBox|null}
     */
    static inputBoxSelected = null;
    /**
     * @static
     * @type {number}
     */
    static lastMouseButtonPressed = null;
}